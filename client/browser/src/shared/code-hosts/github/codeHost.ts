...
const iconClassName = classNames(styles.iconGithub, 'v-align-text-bottom')
...
export const githubCodeHost: CodeHost = {
    ...
    commandPaletteClassProps: {
        ...
        actionItemClassName: classNames(
            styles.commandPaletteActionItemGithub,
    ...
    codeViewToolbarClassProps: {
        className: styles.codeViewToolbarGithub,
        listItemClass: classNames(styles.codeViewToolbarItemGithub, 'BtnGroup'),
        actionItemClass: classNames('btn btn-sm tooltipped tooltipped-s BtnGroup-item', styles.actionItemGithub),
        actionItemPressedClass: 'selected',
        actionItemIconClass: classNames(styles.iconGithub, 'v-align-text-bottom'),
    },
    hoverOverlayClassProps: {
        className: 'Box',
        actionItemClassName: 'btn btn-secondary',
        actionItemPressedClassName: 'active',
        closeButtonClassName: classNames('btn-octicon p-0', styles.hoverOverlayCloseButtonGithub),
        badgeClassName: classNames('label', styles.hoverOverlayBadgeGithub),
