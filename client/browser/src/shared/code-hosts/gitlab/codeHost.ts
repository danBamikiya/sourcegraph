...
export const gitlabCodeHost = subtypeOf<CodeHost>()({
    ...
    commandPaletteClassProps: {
        popoverClassName: classNames('dropdown-menu', styles.commandListPopoverGitlab),
    ...
    codeViewToolbarClassProps: {
        className: styles.codeViewToolbarGitlab,
        actionItemClass: 'btn btn-sm btn-secondary ml-2 action-item--gitlab',
        actionItemPressedClass: 'active',
    },
    hoverOverlayClassProps: {
        className: classNames('card', styles.hoverOverlayGitlab),
        actionItemClassName: 'btn btn-secondary action-item--gitlab',
        actionItemPressedClassName: 'active',
        closeButtonClassName: classNames('btn btn-transparent p-0', styles.btnIconGitlab),
